...
sap.ui.define([
	 ...
	 *
	 */
	var HistoryToolbar = Toolbar.extend("my.zckhoo.portfolio.controls.HistoryToolbar", {
		metadata: {
			aggregations: {
				_overflowButton: {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._callToolbarMethod = function (sFuncName, aArguments) {
	 ...
	 * @override
	 */
	HistoryToolbar.prototype.init = function () {
	...
	HistoryToolbar.prototype.exit = function () {
	 ...
	 */
	HistoryToolbar.prototype.onAfterRendering = function () {
	...
	HistoryToolbar.prototype.onsapfocusleave = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._doLayout = function () {
	...
	HistoryToolbar.prototype._applyFocus = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._preserveChildControlFocusInfo = function () {
		// Preserve focus info
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._resetChildControlFocusInfo = function () {
		this._bControlWasFocused = false;
		this._bOverflowButtonWasFocused = false;
		this.sFocusedChildControlId = "";
	};
	...
	HistoryToolbar.prototype._registerToolbarResize = function () {
	...
	HistoryToolbar.prototype._deregisterToolbarResize = function () {
	...
	// Resize Handler
	HistoryToolbar.prototype._handleResize = function () {
		this._doLayout();
	};
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._cacheControlsInfo = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._updateControlsCachedSizes = function (oControl) {
		var sPriority,
			iControlSize;

		sPriority = HistoryToolbar._getControlPriority(oControl);
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._calculateControlSize = function (oControl) {
		return HistoryToolbar._getOptimalControlWidth(oControl, this._aControlSizes[oControl.getId()]);
	};
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._isControlsInfoCached = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._flushButtonsToPopover = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._invalidateIfHashChanged = function (sHash) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._addOverflowButton = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._aggregateMovableControls = function () {
		var oGroups = {},
			aAggregatedControls = [],
			iControlGroup,
			oPriorityOrder,
		...
		this._aMovableControls.forEach(function (oControl) {
			iControlGroup = HistoryToolbar._getControlGroup(oControl);
			oPriorityOrder = HistoryToolbar._oPriorityOrder;

			if (iControlGroup) {
				sControlPriority = HistoryToolbar._getControlPriority(oControl);
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._extractControlsToMoveToOverflow = function (aAggregatedMovableControls, iToolbarSize) {
		var i,
			vMovableControl;
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._addToPopoverArrAndUpdateContentSize = function (oControl) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._sortByPriorityAndIndex = function (vControlA, vControlB) {
		var oPriorityOrder = HistoryToolbar._oPriorityOrder,
			sControlAPriority = HistoryToolbar._getControlPriority(vControlA),
			sControlBPriority = HistoryToolbar._getControlPriority(vControlB),
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._setControlsOverflowAndShrinking = function (iToolbarSize) {
		var sIdsHash;
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._markControlsWithShrinkableLayoutData = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._collectPopoverOnlyControls = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._moveControlsToPopover = function (iToolbarSize) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._markControlWithShrinkableLayoutData = function (oControl) {
		var sWidth,
			oLayout;
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._resetToolbar = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._removeShrinkingClass = function (oControl) {
		oControl.removeStyleClass(Toolbar.shrinkClass);
	};
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._moveButtonToPopover = function (oButton) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._restoreButtonInToolbar = function (vButton) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._resetAndInvalidateToolbar = function (bHardReset) {
	 ...
	 * @returns {*|Array.<T>}
	 */
	HistoryToolbar.prototype._getVisibleContent = function () {
	 ...
	 * @returns {*|Array.<T>}
	 */
	HistoryToolbar.prototype._getVisibleAndNonOverflowContent = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._getOverflowButton = function () {
		var oOverflowButton;
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._overflowButtonPressed = function (oEvent) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._getPopover = function () {
		var oPopover;
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._shiftPopupShadow = function () {
		var oPopover = this._getPopover(),
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._popOverClosedHandler = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._isNestedInsideAPopup = function () {
		var fnScanForPopup;
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._getOverflowButtonNeeded = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._setOverflowButtonNeeded = function (bValue) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._updateContentInfoInControlsCollections = function (oControl) {
		this._removeContentFromControlsCollections(oControl);
		this._moveControlInSuitableCollection(oControl, HistoryToolbar._getControlPriority(oControl));
	};
	 ...
	 * @public
	 */
	HistoryToolbar.prototype._moveControlInSuitableCollection = function (oControl, sPriority) {
	 ...
	 * @public
	 */
	HistoryToolbar.prototype._removeContentFromControlsCollections = function (oControl) {
		var i,
			aCurrentCollection,
			iIndex;
	...
	HistoryToolbar.prototype._clearAllControlsCollections = function () {
	...
	HistoryToolbar.prototype.onLayoutDataChange = function (oEvent) {
		this._resetAndInvalidateToolbar(true);
		oEvent && this._updateContentInfoInControlsCollections(oEvent.srcControl);
	};

	HistoryToolbar.prototype.addContent = function (oControl) {
	...
	HistoryToolbar.prototype.insertContent = function (oControl, iIndex) {
		this._registerControlListener(oControl);
		this._resetAndInvalidateToolbar(false);
	...
	HistoryToolbar.prototype.removeContent = function () {
	...
	HistoryToolbar.prototype.removeAllContent = function () {
	...
	HistoryToolbar.prototype.destroyContent = function () {
		this._resetAndInvalidateToolbar(false);
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._registerControlListener = function (oControl) {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._deregisterControlListener = function (oControl) {
		var aInvalidationEvents;
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._onContentPropertyChangedOverflowToolbar = function (oEvent) {
		var oSourceControl,
			oControlConfig,
			sParameterName;
	...
	/**
	 * Triggered when invalidation event is fired. Resets and invalidates the HistoryToolbar.
	 * @private
	 */
	HistoryToolbar.prototype._onInvalidationEventFired = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._getOverflowButtonSize = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._getBestPopoverPlacement = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._getControlsIds = function () {
	 ...
	 * @private
	 */
	HistoryToolbar.prototype._getControlIndex = function (vControl) {
	 ...
	 * @private
	 */
	HistoryToolbar._getOptimalControlWidth = function (oControl, iOldSize) {
		var iOptimalWidth,
	 ...
	 * @private
	 */
	HistoryToolbar._getControlPriority = function (vControl) {
	 ...
	 * @private
	 */
	HistoryToolbar._getControlGroup = function (oControl) {
	 ...
	 * @private
	 */
	HistoryToolbar._oPriorityOrder = (function () {
		var oPriorityOrder = {};
	...
	HistoryToolbar.prototype._detireminePopoverVerticalOffset = function () {
		return this.$().parents().hasClass('sapUiSizeCompact') ? 2 : 3;
	};

	HistoryToolbar.prototype.onThemeChanged = function () {
	 ...
	 * @since 1.40
	 */
	HistoryToolbar.prototype.closeOverflow = function () {
		this._getPopover().close();
	};
